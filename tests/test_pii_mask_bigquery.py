...
class TestMaskColumnFlat:
    def test_replaces_domain_in_string_column(self):
        arr = pa.array(["https://www.practo.com/doctors",
                        "https://m.practo.com/app",
                        "https://example.org"])
        result = mask_column(arr, r"practo\.com", "example-health.com")
    ...
    def test_handles_nulls(self):
        arr = pa.array(["practo.com", None, "other.com"])
        result = mask_column(arr, r"practo\.com", "example-health.com")
...
class TestMaskColumnStruct:
    def test_replaces_in_struct_fields(self):
        arr = pa.StructArray.from_arrays(
            [pa.array(["www.practo.com/doctors", "other.com"]),
...
class TestMaskColumnListOfStructs:
    def test_replaces_in_nested_list_struct(self):
        ...
        params = pa.array([
            [{"key": "page_location",
              "value": {"string_value": "https://www.practo.com/consult",
                        "int_value": None}}],
        ], type=pa.list_(param_type))

        result = mask_column(params, r"practo\.com", "example-health.com")
...
class TestMaskEventParams:
    def test_randomizes_gclid(self):
        ...
        assert rows[0][1]["value"]["string_value"] == "https://www.practo.com/"
...
class TestMaskTable:
    def test_full_masking_on_ga4_like_table(self):
        ...
        result = mask_table(table, "practo.com", "example-health.com")
    ...
    def test_consult_paths_redacted(self):
        table = pa.table({
            "url": [
                "https://www.practo.com/consult/penis-size-question-text/q?param=1",
