...
- `/home/ubuntu/data-exporter/service-account.json` — Google service account private key (`private_key_id: 316f1eed07dadce92236ae4a04deb94b0049afb9`, `client_email: user-data-export@org_name-admin-tools.iam.gserviceaccount.com`)
...
`exporters/jira.py:473` hardcodes `org_name.atlassian.net` as the default Jira domain:
```python
parser.add_argument("--domain", default=env("JIRA_DOMAIN", "org_name.atlassian.net"), ...)
```
...
- `/home/ubuntu/data-exporter/google_users.csv` — 519 lines of real `@org_name.com` email addresses
- `/home/ubuntu/data-exporter/slack_channels.csv` — real Slack channel IDs
- `/home/ubuntu/data-exporter/github_repos.csv` — real `org_name/` repo names
