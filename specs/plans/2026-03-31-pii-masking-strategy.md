...
```json
{
  "version": 1,
  "domain_map": {
    "practo.com": "example.com"
  },
  "users": [
    {
      "id": "user-001",
      "real": {
        "email": "john.doe@practo.com",
        "name": "John Doe",
        "first_name": "John",
        "last_name": "Doe",
...
| Slack | `users.list` + `slack-practo-members.csv` | `email` |
...
- Supports custom recognizers (e.g., for Practo-specific patterns like employee IDs)
...
- Custom recognizer for Practo-specific patterns
